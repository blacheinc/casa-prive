        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {packages.map((pkg) => (
                    <div
                        key={pkg.id}
                        className={`bg-slate-800 rounded-lg p-6 border-2 transition ${pkg.isActive
                    ...
                    >
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-2">
                                ...
                                />
                                <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${pkg.isActive
