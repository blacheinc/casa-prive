...
import { Ticket, Search, Eye, CheckCircle, XCircle, Trash2 } from 'lucide-react';
            ...
            <div className="mt-6 space-y-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-red-600 text-white text-sm rounded hover:bg-red-500 transition"
                >
                  Cancel Ticket
                </button>
                <button
                  onClick={() => deleteTicket(selectedTicket.id)}
                  className="px-4 py-2 bg-red-900 text-red-300 text-sm rounded hover:bg-red-800 transition"
                >
                  Delete Ticket
                </button>
              </div>
